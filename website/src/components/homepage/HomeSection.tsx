          ...
          <div className="mx-auto max-w-6xl px-6 lg:px-8">
            <div className="mx-auto max-w-4xl text-center">
              ...
              <div className="mt-10 flex items-center justify-center gap-x-6">
                <a href="https://github.com/baidu/bifromq" target='_blank' className="text-white inline-flex items-center rounded-md bg-blue-600 px-3.5 py-2.5 text-sm font-semibold  shadow-sm hover:bg-blue-600 hover:text-gray-50 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-blue-600">
                ...
                <a href="./docs/Readme/" className="text-sm font-semibold leading-6">
